            ...
            <div className="space-y-6">
              {messages.length === 0 && streamingMessage === null ? (
                <div className="text-center text-muted-foreground pt-16">
                  <Image src="/images/phorix-icon.png" alt="Phorix Logo" width={64} height={64} className="w-16 h-16 mx-auto mb-4 rounded-full" />
                  ...
                  >
                    {message.role === "assistant" && (
                       <Avatar className="w-9 h-9 border p-1 bg-white">
                        <Image src="/images/phorix-icon.png" alt="Phorix Logo" width={36} height={36} className="rounded-full"/>
                      </Avatar>
                    )}
                    <div
                      className={cn(
